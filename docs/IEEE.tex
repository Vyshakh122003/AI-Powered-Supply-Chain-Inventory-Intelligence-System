...
I ran a daily orchestration that executes eight workflows in sequence. I tested it with six products. The monthly cost for a single store is under Rs. 500. The owner gets timely alerts without any extra effort.
\end{abstract}
