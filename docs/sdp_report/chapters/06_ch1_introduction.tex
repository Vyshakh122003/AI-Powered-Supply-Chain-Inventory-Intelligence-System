...
Small Indian retail stores lack access to an affordable, automated, and intelligent inventory
management system that can predict stockout dates, generate supplier-aware reorder
recommendations, score supplier performance, and deliver real-time alerts through a channel
that store owners already use daily. Existing enterprise solutions are financially and
operationally inaccessible to this segment, while simpler tools provide only passive
transaction recording without any proactive intelligence or automation.
...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=4pt]
  ...
  \item To develop an AI-powered reorder recommendation engine using the Groq Llama~3.1~8B
        large language model that generates natural-language reorder suggestions with supplier
        selection reasoning based on current stock levels, demand patterns, and supplier grades.
