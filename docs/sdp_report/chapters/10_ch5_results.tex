...
{\singlespacing
\begin{longtable}{@{}p{0.4cm} p{2.8cm} p{3.5cm} p{3.5cm} p{1.5cm}@{}}
...
{\sffamily\small [Screenshot: Main Dashboard showing Inventory Health Score gauge at 55/100,\\
KPI cards for Total Products (10), High Risk (6), Active Alerts (6), and Suggestions (3),\\
and the 7-day health score trend chart.]}
\vspace{2.5cm}
\end{minipage}}
...
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{2.5cm}
{\sffamily\small [Screenshot: Products page showing product table with risk-level colour-coded\\
badges (HIGH in red, MEDIUM in amber, LOW in green), days-to-stockout column,\\
and the Add Product / AI Smart Scan / CSV Import buttons.]}
\vspace{2.5cm}
\end{minipage}}
\caption{StockSense AI — Products Management Page with Risk Badges.}
...
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{2.5cm}
{\sffamily\small [Screenshot: AI Reorder Suggestions page showing cards for each at-risk\\
product, the recommended supplier name with grade badge, suggested order quantity,\\
and the Groq-generated reason text with Approve / Dismiss action buttons.]}
\vspace{2.5cm}
\end{minipage}}
\caption{StockSense AI — AI Reorder Suggestions Page.}
...
{\sffamily\small [Screenshot: Supplier Analytics page showing supplier table with composite\\
score column, grade badge (A/B/C/D), and individual metric bars for Reliability,\\
Price Score, and Delivery Speed.]}
\vspace{2.0cm}
\end{minipage}}
...
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{2.0cm}
{\sffamily\small [Screenshot: Settings page showing the Run Pipeline button with the\\
animated pipeline processing overlay, displaying sequential workflow execution\\
status indicators and the final green success confirmation.]}
\vspace{2.0cm}
\end{minipage}}
...
\fbox{\begin{minipage}{0.85\textwidth}
\centering\vspace{2.0cm}
{\sffamily\small [Screenshot: WhatsApp message received on the store owner's phone showing\\
the formatted stock alert with product names, current stock levels, reorder thresholds,\\
and the StockSense AI branding header.]}
\vspace{2.0cm}
\end{minipage}}
...
\toprule
\textbf{Feature} & \textbf{StockSense AI} & \textbf{Vyapar} &
\textbf{Zoho Inventory} & \textbf{Khatabook} \\
\midrule
AI Reorder Suggestions & Yes & No & Limited & No \\
Automated Stockout Prediction & Yes & Manual & Basic & No \\
Supplier Scoring & WSM-based & No & Basic & No \\
WhatsApp Alerts & Automated & No & No & No \\
AI Vision Data Entry & Yes & No & No & No \\
Monthly Cost & \rupee{}0--500 & \rupee{}0--599 & \rupee{}4,000+ & \rupee{}0 \\
Setup Complexity & Low & Medium & High & Low \\
Real-time Dashboard & Yes & Limited & Yes & No \\
Hardware Required & No & No & No & No \\
Prediction Method & Velocity-based & None & Basic & None \\
\bottomrule
\end{tabularx}
}
\end{table}
