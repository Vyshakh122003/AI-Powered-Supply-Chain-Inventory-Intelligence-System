...
{\singlespacing
\begin{longtable}{@{}p{2.6cm} p{1.4cm} p{1.4cm} p{1.4cm} p{1.4cm} p{1.4cm} p{1.6cm}@{}}
\caption{Comparative Analysis of Related Works vs.\ StockSense AI}
\label{tab:litcomp} \\
\toprule
\textbf{Feature} &
\textbf{Wang et al.\ 2024} &
\textbf{Kheawpeam 2023} &
\textbf{Manoharan 2024} &
\textbf{Poongothai 2024} &
\textbf{Amir \& Atif 2025} &
\textbf{StockSense AI} \\
\midrule
\endfirsthead
\toprule
...
\bottomrule
\endfoot
Hardware-free & No & Yes & No & No & Yes & Yes \\
LLM Integration & No & No & No & No & No & Yes \\
WhatsApp Alerts & No & No & No & No & No & Yes \\
Supplier Scoring & No & No & No & No & No & Yes \\
Stockout Prediction & Basic & ML-based & Sensor-based & ML-based & No & Rule-based \\
AI Vision & No & No & No & CNN-based & No & Gemini Flash \\
Cost (\rupee/mo) & High & High & High & High & Low & $<$500 \\
Deployable Prototype & No & No & No & No & No & Yes \\
\end{longtable}
}
