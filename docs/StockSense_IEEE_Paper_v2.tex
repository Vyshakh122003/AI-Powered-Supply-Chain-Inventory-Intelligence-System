...
\definecolor{modgreen}{RGB}{42,141,130}
\definecolor{hdrnavy}{RGB}{61,79,111}
\definecolor{barteal}{RGB}{31,92,84}
...
\begin{tikzpicture}[align=center,
  md/.style={rectangle, rounded corners=2pt, fill=modgreen, text=white,
    font=\sffamily\tiny, minimum height=0.5cm, text centered, inner sep=2pt},
  hd/.style={rectangle, rounded corners=1pt, fill=hdrnavy, text=white,
    font=\sffamily\tiny\bfseries, minimum height=0.3cm, text centered, inner sep=2pt},
]

% ====== LAYER 1: React 19 Frontend SPA ======
\draw[gray!50, rounded corners=3pt, fill=gray!4] (0,0) rectangle (10.5,-3.1);
\node[font=\sffamily\scriptsize\bfseries] at (5.25,-0.25) {React 19 Frontend SPA};

% -- Core Modules --
\draw[gray!35, rounded corners=2pt] (0.15,-0.55) rectangle (3.25,-2.85);
...
% -- Inventory Ops --
\draw[gray!35, rounded corners=2pt] (3.5,-0.55) rectangle (7.0,-2.85);
...
% -- Support & Auth --
\draw[gray!35, rounded corners=2pt] (7.25,-0.55) rectangle (10.35,-2.85);
...
\fill[barteal, rounded corners=3pt] (0,-3.4) rectangle (10.5,-4.6);
\node[font=\sffamily\scriptsize\bfseries, text=white] at (5.25,-3.65) {Network \& Security Bridge};
\node[md, text width=2.4cm, fill=modgreen!85!black] at (2.8,-4.15) {Vite Proxy Server (:5173)};
\draw[-Stealth, thick, white] (4.2,-4.15) -- (6.3,-4.15);
\node[md, text width=2.8cm, fill=modgreen!85!black] at (7.7,-4.15) {ngrok Secure Tunnel (HTTPS)};

% ====== LAYER 3: n8n AI Workflow Engine ======
\draw[gray!50, rounded corners=3pt, fill=gray!4] (0,-4.9) rectangle (10.5,-7.15);
\node[font=\sffamily\scriptsize\bfseries] at (5.25,-5.15) {n8n AI Workflow Engine};

% WF-08 Orchestrator sub-box
\draw[gray!35, rounded corners=2pt] (0.15,-5.4) rectangle (8.7,-6.9);
...
% External APIs box
\node[rectangle, draw=gray!50, rounded corners=2pt, fill=white,
...
\draw[-Stealth, thick, gray!60] (8.7,-6.15) -- (api.west);

% ====== LAYER 4: Supabase Cloud Infrastructure ======
\draw[gray!50, rounded corners=3pt, fill=gray!4] (0,-7.45) rectangle (10.5,-8.9);
