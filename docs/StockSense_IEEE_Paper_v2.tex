...
% -- Core Modules --
\draw[black!60, rounded corners=2pt, dash pattern=on 4pt off 4pt] (0.15,-0.55) rectangle (3.25,-2.85);
...
% -- Inventory Ops --
\draw[black!60, rounded corners=2pt, dash pattern=on 4pt off 4pt] (3.5,-0.55) rectangle (7.0,-2.85);
...
% -- Support & Auth --
\draw[black!60, rounded corners=2pt, dash pattern=on 4pt off 4pt] (7.25,-0.55) rectangle (10.35,-2.85);
...
\draw[black!60, rounded corners=2pt, dash pattern=on 4pt off 4pt] (0.15,-5.4) rectangle (8.7,-6.95);
\node[hd, text width=8.2cm] at (4.425,-5.6) {WF-08: Master Daily Orchestrator};
\node[md, text width=0.95cm] at (0.7,-6.2) {WF-01\\(Ingest)};
\node[md, text width=1.05cm] at (1.85,-6.2) {WF-02\\(Calc)};
\node[md, text width=1.05cm] at (3.0,-6.2) {WF-03\\(Alerts)};
\node[md, text width=0.95cm] at (4.15,-6.2) {WF-04\\(Risk)};
\node[md, text width=1.15cm] at (5.35,-6.2) {WF-05\\(AI Sugg.)};
\node[md, text width=1.15cm] at (6.65,-6.2) {WF-06\\(Scoring)};
\node[md, text width=1.2cm] at (7.95,-6.2) {WF-07\\(WhatsApp)};
