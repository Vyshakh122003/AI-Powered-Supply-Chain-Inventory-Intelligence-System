...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      ...
      <button
        onClick={() => navigate('/')}
        className="absolute top-6 left-6 inline-flex items-center gap-2 px-3 py-2 bg-primary text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer"
        title="Go to home"
      >
        ...
        >
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-muted">
              <Link to="/reset-password" className="text-accent font-medium hover:underline">
                Forgot password?
              </Link>
            </p>
            <p className="text-sm text-muted">
